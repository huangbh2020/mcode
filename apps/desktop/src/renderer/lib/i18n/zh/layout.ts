...
export const zh = {
  ...
  "layout.showWorktreeThreads": "显示工作树会话",
  "layout.showLocalThreads": "显示本地会话",
  "layout.threadsInWorktrees": "会话都在工作树中,点击查看",
  "layout.mergeWorktreeBack": "合并回本地分支(该工作树全部未合并改动)",
  "layout.renameWorktree": "重命名工作树",
  ...
  "layout.pinnedProjectsSection": "置顶项目 ({n})",
  "layout.pin": "置顶",
  "layout.unpin": "取消置顶",
  "layout.archive": "归档",
  ...
  "layout.renameProject": "重命名项目",
  "layout.renameProjectDesc": "为项目设置新的显示名称，不会改动磁盘上的文件夹。",
  "layout.projectNamePlaceholder": "项目名称",
