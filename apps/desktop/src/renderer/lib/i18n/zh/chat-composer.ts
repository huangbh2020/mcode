...
export const zh = {
  ...
  "chat.effort.hintCodexDefault": "不显式指定 effort,由模型使用自身默认档位",
  ...
  "chat.permission.hintCodexFullAccess": "可修改工作区外文件并访问互联网,无需审批;请谨慎使用",
  ...
  "chat.worktree.hintWtDetached": "隔离目录随便试,不建分支,用完可整目录丢弃",
  "chat.worktree.optionWtBranch": "工作树 · 分支",
  "chat.worktree.hintWtBranch": "自动创建 mcode/* 分支,提交长期保留、可合并回",
  "chat.worktree.pendingDetached": "工作树 · 沙盒",
  "chat.worktree.pendingBranch": "工作树 · 分支",
  "chat.worktree.active": "工作树",
  "chat.worktree.chipTitleLocal": "新会话在项目根目录工作;点击可切换为隔离工作树(沙盒/分支两种形态)",
  "chat.worktree.chipTitlePendingDetached": "首条消息后将创建隔离工作树(不建分支,用完可丢弃);点击可切换形态或切回本地",
  "chat.worktree.chipTitlePendingBranch": "首条消息后将创建隔离工作树并生成 mcode/* 分支(提交长期保留,可合并回);点击可切换形态或切回本地",
  "chat.worktree.chipTitleActive": "本会话运行于隔离工作树:{path}",
  "chat.worktree.mergeBack": "合并回",
  "chat.worktree.commitMsgLabel": "未提交改动的提交消息(自动提交时使用)",
  "chat.worktree.commitMsgPlaceholder": "留空使用默认:worktree: auto-commit before merge back ({name})",
  ...
  "chat.worktree.retainedBranch": "工作树已删除;分支 {branch} 含未合并提交,已为您保留,可随时用 git checkout {branch} 找回。",
