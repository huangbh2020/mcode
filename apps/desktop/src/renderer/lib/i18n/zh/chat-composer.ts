...
export const zh = {
  ...
  "chat.worktree.hintWtDetached": "detached 检出,不建分支,适合实验性验证",
  "chat.worktree.optionWtBranch": "工作树 · 开发",
  "chat.worktree.hintWtBranch": "自动创建 mcode/* 分支,提交长期保留",
  "chat.worktree.pendingDetached": "工作树 · 实验",
  "chat.worktree.pendingBranch": "工作树 · 开发",
  "chat.worktree.active": "工作树",
  "chat.worktree.chipTitleLocal": "新会话在项目根目录工作;点击可切换为隔离工作树(实验/开发两种形态)",
  "chat.worktree.chipTitlePendingDetached": "首条消息后将创建隔离工作树(detached 检出,改动不建分支);点击可切换形态或切回本地",
  "chat.worktree.chipTitlePendingBranch": "首条消息后将创建隔离工作树并生成 mcode/* 分支(提交长期保留);点击可切换形态或切回本地",
