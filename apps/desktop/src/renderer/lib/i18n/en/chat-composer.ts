...
export const en = {
  ...
  "chat.permission.hintCodexFullAccess": "Files outside the workspace can be edited and the internet accessed without approval. Exercise caution",
  ...
  "chat.worktree.hintWtDetached": "isolated directory, no branch — discard the whole thing when done",
  "chat.worktree.optionWtBranch": "Worktree · Branch",
  "chat.worktree.hintWtBranch": "auto-created mcode/* branch — commits are durable and mergeable back",
  "chat.worktree.pendingDetached": "Worktree · Sandbox",
  "chat.worktree.pendingBranch": "Worktree · Branch",
  "chat.worktree.active": "Worktree",
  "chat.worktree.chipTitleLocal": "New sessions work in the project root; click to switch to an isolated worktree (sandbox / branch forms)",
  "chat.worktree.chipTitlePendingDetached": "A sandbox worktree is created on the first message (no branch — discard when done); click to change the form or switch back to local",
  "chat.worktree.chipTitlePendingBranch": "A worktree on a generated mcode/* branch is created on the first message (commits are durable, mergeable back); click to change the form or switch back to local",
  ...
  "chat.worktree.commitMsgPlaceholder": "Leave blank to use the default: worktree: auto-commit before merge back ({name})",
  ...
  "chat.worktree.retainedBranch": "Worktree removed; branch {branch} holds unmerged commits and was kept for you — recover them anytime with git checkout {branch}.",
