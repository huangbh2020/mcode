...
export const en = {
  ...
  "chat.worktree.hintWtDetached": "detached checkout, no branch — throwaway verification",
  "chat.worktree.optionWtBranch": "Worktree · Dev",
  "chat.worktree.hintWtBranch": "auto-generated mcode/* branch — commits are durable",
  "chat.worktree.pendingDetached": "Worktree · Experiment",
  "chat.worktree.pendingBranch": "Worktree · Dev",
  "chat.worktree.active": "Worktree",
  "chat.worktree.chipTitleLocal": "New sessions work in the project root; click to switch to an isolated worktree (experiment / dev forms)",
  "chat.worktree.chipTitlePendingDetached": "A detached worktree is created on the first message (no branch — experimental); click to change the form or switch back to local",
  "chat.worktree.chipTitlePendingBranch": "A worktree on a generated mcode/* branch is created on the first message (commits are durable); click to change the form or switch back to local",
