...
export const en = {
  ...
  "layout.showWorktreeThreads": "Show worktree threads",
  "layout.showLocalThreads": "Show local threads",
  "layout.threadsInWorktrees": "All threads live in worktrees — click to view",
  "layout.mergeWorktreeBack": "Merge back into local branch (all unmerged changes)",
  "layout.renameWorktree": "Rename worktree",
  ...
  "layout.pinnedProjectsSection": "Pinned projects ({n})",
  "layout.pin": "Pin",
  "layout.unpin": "Unpin",
  ...
  "layout.renameProject": "Rename project",
  "layout.renameProjectDesc": "Set a new display name for the project. The folder on disk is not touched.",
  "layout.projectNamePlaceholder": "Project name",
