...
/** Pre-set issue category for AI generation. */
export type GitHubIssueKind = "bug" | "feature" | "general";

/** Output generated by AI for a GitHub issue. */
export interface GitHubGenerateIssueResult {
  title: string;
  body: string;
}
